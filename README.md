...
* **Friends**: From a public profile or the private Friends section, paste a handle to send a mutual friend request. The recipient must accept; requests can be declined or blocked, accepted friends can be removed from the profile page or Friends popup, and the friend list is never public.
