...
|---|---|---|---|
| Request scheduling | [`core/request_manager.py`](../core/request_manager.py) | `RequestManager`, `RequestHandle`, `cancel_if_unsubscribed()`, `cancel_matching()` | active |
...
| Cloud domain models/storage | [`core/cloud_models.py`](../core/cloud_models.py), [`core/cloud_storage.py`](../core/cloud_storage.py) | `SyncStatus`, `SaveStats`, `get_cloud_root` | active; UI-safe cloud metadata and local-root configuration without importing the save engine |
