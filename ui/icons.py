...
ICONS = {
    ...
    "minimize": ("ph.minus-bold", "#6F7682"),
    "maximize": ("ph.square-bold", "#6F7682"),
    "restore": ("ph.copy-simple-bold", "#6F7682"),
    "close": ("ph.x-bold", "#6F7682"),
    "search": ("ph.magnifying-glass-bold", "#6F7682"),
    "shield": ("ph.shield-check-bold", "#35C98A"),
    "globe": ("ph.globe-bold", "#3B9FE8"),
    "wine": ("ph.wine-bold", "#A7ADB8"),
    "terminal": ("ph.terminal-window-bold", "#A7ADB8"),
